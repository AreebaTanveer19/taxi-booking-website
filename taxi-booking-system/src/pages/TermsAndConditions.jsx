...
const TermsAndConditions = () => (
  <div className="step-container" style={{ maxWidth: 900, margin: "0 auto" }}>
    <h2 className="step-title" style={{ textAlign: "center" }}>Terms and Conditions</h2>
    <div style={{ whiteSpace: "pre-line", marginTop: 24, fontSize: 16, color: '#444' }}>
      <strong>PLEASE READ CAREFULLY.<br></br>BY USING THIS SITE, YOU AGREE TO THESE TERMS OF USE.</strong>
<br></br>
...
- For sedans: You may cancel or change your booking up to 24 hours before pickup by emailing us. Cancellations within 24 hours will be charged the full fare.
- For vans, limousines, and special events: Cancellations must be made at least 24 hours in advance. After this, full charges apply. Deposits for weddings and formals are non-refundable.
<br></br>
<br></br>
...
<a href="https://www.horizonchauffeurs.com.au/terms-and-conditions" target="_blank" rel="noopener noreferrer">https://www.horizonchauffeurs.com.au/terms-and-conditions</a>
    </div>
  </div>
);
